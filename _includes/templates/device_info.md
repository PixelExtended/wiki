...
## Get Pixel Extended for the {{ device.vendor }} {{ device.name }}
[Get the builds here](https://sourceforge.net/projects/pixelextended/files/{{ device.codename }})
...
{%- endif %}
- [Update to a newer build of the same Pixel Extended version]({{ path_prefix | append: "/update" | relative_url }})
...
You can find assistance with Pixel Extended on [our Telegram group](https://t.me/pixelextendedchat).
