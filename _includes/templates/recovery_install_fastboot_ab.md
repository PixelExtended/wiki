...
{% include alerts/note.html content="This is temporary because the recovery is part of the OS and will be replaced once you install Pixel Extended. It is not optional, though!" %}
{% else %}
...
{% else %}
{%- assign is_pe_recovery = true %}
1. Download the [PixelExperience Recovery](https://download.pixelextended.org/{{ device.codename }}). Simply download the latest recovery file.
{% endif %}
